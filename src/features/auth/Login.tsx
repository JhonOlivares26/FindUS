        ...
        <div className="flex flex-row w-full">
          ...
          <div className="hidden lg:flex flex-col justify-between bg-[#143C3A] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg w-1/3">
            ...
            <div className='space-y-5'>
              <h1 className="lg:text-3xl xl:text-5xl xl:leading-snug font-extrabold text-white">Entra en tu cuenta y descubre nuevas conexiones</h1>
          ...
          <div className="flex flex-1 flex-col items-center justify-center px-10 py-10 relative">
            ...
            <div className="flex flex-1 flex-col justify-center space-y-5 max-w-md">
              ...
              <div className="flex flex-col max-w-md space-y-5">
                ...
                <button className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-white text-black hover:bg-black hover:text-white">
                  Inicia sesión con...
                </button>
